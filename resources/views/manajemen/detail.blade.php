            ...
            <div class="row mt-4">
                ...
                <div class="card p-0 m-0">
                    ...
                    <div class="card-body p-2 m-0">
                        ...
                        <form action="{{ route('manajemen.update', $dt->id) }}" method="" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row g-3">
                                <div class="col-md-6">
                            ...
                            <table class="table table-bordered" style="border: 1px solid black; border-collapse: collapse">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input disabled value="{{$dt->nilai_1_a}}" name="nilai_1_a" type="number" class="form-control text-center" placeholder="1 - 30" ></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input disabled value="{{$dt->nilai_2_a}}" name="nilai_2_a" type="number" class="form-control text-center" placeholder="1 - 20" ></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">1-20</td>
                                        <td><input disabled value="{{$dt->nilai_3_a}}" name="nilai_3_a" type="number" class="form-control text-center" placeholder="1 - 20" ></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">1-10</td>
                                        <td><input disabled value="{{$dt->nilai_6_a}}" name="nilai_6_a" type="number" class="form-control text-center" placeholder="1 - 10" ></td>
                                        <td><textarea disabled name="ket_6_a" class="form-control" placeholder="Keterangan" style="height: 42px">{{$dt->ket_6_a}}</textarea></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-4">B. Tidak Ada</td>
                                        <td class="text-center">0</td>
                                        <td><input disabled value="{{$dt->nilai_6_b}}" name="nilai_6_b" type="number" class="form-control text-center" placeholder="0" ></td>
                                        <td><textarea disabled name="ket_6_b" class="form-control" placeholder="Keterangan" style="height: 42px">{{$dt->ket_6_b}}</textarea></td>
                                    </tr>
                                    <!-- SAMPAI SINI  -->
                                    <tr>
                                        <td></td>
