                                        ...
                                        <tr class="text-center w-100">
                                            ...
                                            <td>
                                                ...
                                                <div class="text-center ">
                                                    <a class="btn btn-link text-success text-gradient px-3 mb-0" href="{{ route('aset-dan-permodalan.show', $data->id) }}"><i class="fas fa-clipboard-list me-2"></i>Detail</a>
                                                    <a class="btn btn-link text-dark px-3 mb-0" href="{{ route('aset-dan-permodalan.edit', $data->id) }}"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
                                                    <form action="{{ route('aset-dan-permodalan.destroy', $data->id) }}" method="post">
                                                        @method('delete')
                                                        @csrf
