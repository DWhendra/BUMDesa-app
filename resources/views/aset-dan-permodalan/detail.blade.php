                            ...
                            <table class="table table-bordered" style="border: 1px solid black; border-collapse: collapse">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input disabled value="{{$dt->nilai_1_a}}" name="nilai_1_a" type="number" class="form-control text-center" placeholder="10 - 20" ></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input disabled value="{{$dt->nilai_1_b}}" name="nilai_1_b" type="number" class="form-control text-center" placeholder="1 - 9" ></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">20</td>
                                        <td><input disabled value="{{$dt->nilai_2_a}}" name="nilai_2_a" type="number" class="form-control text-center" placeholder="20" ></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input disabled value="{{$dt->nilai_2_b}}" name="nilai_2_b" type="number" class="form-control text-center" placeholder="40" ></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input disabled value="{{$dt->nilai_2_c}}" name="nilai_2_c" type="number" class="form-control text-center" placeholder="60" ></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">80</td>
                                        <td><input disabled value="{{$dt->nilai_2_d}}" name="nilai_2_d" type="number" class="form-control text-center" placeholder="80" ></td>
