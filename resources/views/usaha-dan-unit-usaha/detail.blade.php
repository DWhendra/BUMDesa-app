            ...
            <div class="row mt-4">
                ...
                <div class="card p-0 m-0">
                    ...
                    <div class="card-body p-2 m-0">
                        ...
                        <form action="{{ route('usaha-dan-unit-usaha.update', $dt->id) }}" method="" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input disabled value="{{$dt->bumdesa->nama_bumdes}}" name="bumdesa" type="text" class="form-control" id="floatingInput" placeholder="nama" required>                                        <label for="floatingInput">Nama BUM Desa</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                        ...
                        <table class="table table-bordered" style="border: 1px solid black; border-collapse: collapse">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input disabled value="{{$dt->nilai_1_a}}" name="nilai_1_a" type="number" class="form-control text-center" placeholder="1 - 20" ></td>
                                ...
                                <tr>
                                    ...
                                    <td><input disabled value="{{$dt->nilai_1_b}}" name="nilai_1_b" type="number" class="form-control text-center" placeholder="0" ></td>
                                ...
                                <tr>
                                    ...
                                    <td><input disabled value="{{$dt->nilai_2_a}}" name="nilai_2_a" type="number" class="form-control text-center" placeholder="1 - 10" ></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">0</td>
                                    <td><input disabled value="{{$dt->nilai_2_b}}" name="nilai_2_b" type="number" class="form-control text-center" placeholder="0" ></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">1-10</td>
                                    <td><input disabled value="{{$dt->nilai_3_a}}" name="nilai_3_a" type="number" class="form-control text-center" placeholder="1 - 10" ></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">30</td>
                                    <td><input disabled value="{{$dt->nilai_4_a}}" name="nilai_4_a" type="number" class="form-control text-center" placeholder="30" ></td>
                                ...
                                <tr>
                                    ...
                                    <td><input disabled value="{{$dt->nilai_4_b}}" name="nilai_4_b" type="number" class="form-control text-center" placeholder="15" ></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">5</td>
                                    <td><input disabled value="{{$dt->nilai_4_c}}" name="nilai_4_c" type="number" class="form-control text-center" placeholder="5" ></td>
                                    <td><textarea disabled name="ket_4_c" class="form-control" placeholder="Keterangan" style="height: 42px">{{$dt->ket_4_c}}</textarea></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">0</td>
                                    <td><input disabled value="{{$dt->nilai_4_d}}" name="nilai_4_d" type="number" class="form-control text-center" placeholder="0" ></td>
                                    <td><textarea disabled name="ket_4_d" class="form-control" placeholder="Keterangan" style="height: 42px">{{$dt->ket_4_d}}</textarea></td>
                                </tr>
                                <!-- SAMPAI SINI  -->
                                <!--DARI SINI -->
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">30</td>
                                    <td><input disabled value="{{$dt->nilai_5_a}}" name="nilai_5_a" type="number" class="form-control text-center" placeholder="30" ></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">20</td>
                                    <td><input disabled value="{{$dt->nilai_5_b}}" name="nilai_5_b" type="number" class="form-control text-center" placeholder="20" ></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">15</td>
                                    <td><input disabled value="{{$dt->nilai_5_c}}" name="nilai_5_c" type="number" class="form-control text-center" placeholder="15" ></td>
                                    <td><textarea disabled name="ket_5_c" class="form-control" placeholder="Keterangan" style="height: 42px">{{$dt->ket_5_c}}</textarea></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">10</td>
                                    <td><input disabled value="{{$dt->nilai_5_d}}" name="nilai_5_d" type="number" class="form-control text-center" placeholder="10" ></td>
                                    <td><textarea disabled name="ket_5_d" class="form-control" placeholder="Keterangan" style="height: 42px">{{$dt->ket_5_d}}</textarea></td>
                                </tr>
                                <!-- SAMPAI SINI  -->
                                <tr>
                                    <td></td>
                    ...
                    <a href="{{ route('rekapitulasi.detailRekapitulasi', ['id_bumdesa' => $dt->bumdesa->id, 'tahun' => $dt->tahun]) }}"><button class="btn btn-secondary btn-lg w-100">Kembali</button></a>
                    </div>
                </div>
            </div>
        </div>
