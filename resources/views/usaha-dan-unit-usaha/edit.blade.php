            ...
            <div class="row mt-4">
                ...
                <div class="card p-0 m-0">
                    ...
                    <div class="card-body p-2 m-0">
                        ...
                        <form action="{{ route('usaha-dan-unit-usaha.update', $dt->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row g-3">
                                <div class="col-md-4">
                        ...
                        <table class="table table-bordered" style="border: 1px solid black; border-collapse: collapse">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input value="{{$dt->nilai_1_a}}" name="nilai_1_a" type="number" class="form-control text-center" placeholder="1 - 20" ></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">30</td>
                                    <td><input value="{{$dt->nilai_4_a}}" name="nilai_4_a" type="number" class="form-control text-center" placeholder="30" ></td>
                                ...
                                <tr>
                                    ...
                                    <td><input value="{{$dt->nilai_4_b}}" name="nilai_4_b" type="number" class="form-control text-center" placeholder="15" ></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">5</td>
                                    <td><input value="{{$dt->nilai_4_c}}" name="nilai_4_c" type="number" class="form-control text-center" placeholder="5" ></td>
                                    <td><textarea name="ket_4_c" class="form-control" placeholder="Keterangan" style="height: 42px">{{$dt->ket_4_c}}</textarea></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">0</td>
                                    <td><input value="{{$dt->nilai_4_d}}" name="nilai_4_d" type="number" class="form-control text-center" placeholder="0" ></td>
                                    <td><textarea name="ket_4_d" class="form-control" placeholder="Keterangan" style="height: 42px">{{$dt->ket_4_d}}</textarea></td>
                                </tr>
                                <!-- SAMPAI SINI  -->
                                <!--DARI SINI -->
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">30</td>
                                    <td><input value="{{$dt->nilai_5_a}}" name="nilai_5_a" type="number" class="form-control text-center" placeholder="30" ></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">20</td>
                                    <td><input value="{{$dt->nilai_5_b}}" name="nilai_5_b" type="number" class="form-control text-center" placeholder="20" ></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">15</td>
                                    <td><input value="{{$dt->nilai_5_c}}" name="nilai_5_c" type="number" class="form-control text-center" placeholder="15" ></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">10</td>
                                    <td><input value="{{$dt->nilai_5_d}}" name="nilai_5_d" type="number" class="form-control text-center" placeholder="10" ></td>
