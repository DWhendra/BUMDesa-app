    ...
    <x-slot:topmenu>
                                ...
                                <div class="col-md-3">
                                    <div class="form-floating mb-3">
                                        <div class="form-floating">
                                            <select class="form-select input" name="kategori" id="select-indikator" aria-label="Floating label select example" required>
                            ...
                            <table class="table table-bordered" style="border: 1px solid black; border-collapse: collapse">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="nilai_1_a" type="number" class="form-control text-center" placeholder="1 - 30" ></td>
                                        <td><textarea name="ket_1_a" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="nilai_2_a" type="number" class="form-control text-center" placeholder="1 - 20" ></td>
                                        <td><textarea name="ket_2_a" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">1-20</td>
                                        <td><input name="nilai_3_a" type="number" class="form-control text-center" placeholder="1 - 20" ></td>
                                        <td><textarea name="ket_3_a" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">1-10</td>
                                        <td><input name="nilai_4_a" type="number" class="form-control text-center" placeholder="1 - 10" ></td>
                                        <td><textarea name="ket_4_a" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">1-10</td>
                                        <td><input name="nilai_5_a" type="number" class="form-control text-center" placeholder="1 - 10" ></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-4">B. Tidak Ada</td>
                                        <td class="text-center">0</td>
                                        <td><input name="nilai_5_b" type="number" class="form-control text-center" placeholder="0" ></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">1-10</td>
                                        <td><input name="nilai_6_a" type="number" class="form-control text-center" placeholder="1 - 10" ></td>
                                        <td><textarea name="ket_6_a" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-4">B. Tidak Ada</td>
                                        <td class="text-center">0</td>
                                        <td><input name="nilai_6_b" type="number" class="form-control text-center" placeholder="0" ></td>
                                        <td><textarea name="ket_6_b" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                    </tr>
                                    <!-- SAMPAI SINI  -->
                            ...
                            <table class="table table-bordered" style="border: 1px solid black; border-collapse: collapse">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-4">A. Ada</td>
                                        <td class="text-center">1-10</td>
                                        <td><input name="nilai_1_a" type="number" class="form-control text-center" placeholder="1 - 10" ></td>
                                        <td><textarea name="ket_1_a" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">1-10</td>
                                        <td><input name="nilai_5_b" type="number" class="form-control text-center" placeholder="1 - 10" ></td>
                                        <td><textarea name="ket_5_b" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">1-10</td>
                                        <td><input name="nilai_5_c" type="number" class="form-control text-center" placeholder="1 - 10" ></td>
                                        <td><textarea name="ket_5_c" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">1-10</td>
                                        <td><input name="nilai_5_d" type="number" class="form-control text-center" placeholder="1 - 10" ></td>
                                        <td><textarea name="ket_5_d" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">1-10</td>
                                        <td><input name="nilai_5_e" type="number" class="form-control text-center" placeholder="1 - 10" ></td>
                                        <td><textarea name="ket_5_e" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">1-10</td>
                                        <td><input name="nilai_5_f" type="number" class="form-control text-center" placeholder="1 - 10" ></td>
                                        <td><textarea name="ket_5_f" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                    </tr>
                                    <!-- SAMPAI SINI  -->
                        ...
                        <fieldset id="alka" disabled style="display: none">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input name="nilai_1_a" type="number" class="form-control text-center" placeholder="15 - 20" ></td>
                                    <td><textarea name="ket_1_a" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    ...
                                    <td><input name="nilai_1_b" type="number" class="form-control text-center" placeholder="10 - 14" ></td>
                                    <td><textarea name="ket_1_b" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    ...
                                    <td class="text-center">1-9</td>
                                    <td><input name="nilai_1_c" type="number" class="form-control text-center" placeholder="1 - 9" ></td>
                                    <td><textarea name="ket_1_c" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    ...
                                    <td class="text-center">0</td>
                                    <td><input name="nilai_1_d" type="number" class="form-control text-center" placeholder="0" ></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">15-20</td>
                                    <td><input name="nilai_2_a" type="number" class="form-control text-center" placeholder="15 - 20" ></td>
                                    <td><textarea name="ket_2_a" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    ...
                                    <td class="text-center">10-14</td>
                                    <td><input name="nilai_2_b" type="number" class="form-control text-center" placeholder="10 - 14" ></td>
                                    <td><textarea name="ket_2_b" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    ...
                                    <td class="text-center">1-9</td>
                                    <td><input name="nilai_2_c" type="number" class="form-control text-center" placeholder="1 - 9" ></td>
                                    <td><textarea name="ket_2_c" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td class="ps-4">D. Tidak Ada</td>
                                    <td class="text-center">0</td>
                                    <td><input name="nilai_2_d" type="number" class="form-control text-center" placeholder="0" ></td>
                                    <td><textarea name="ket_2_d" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">10-20</td>
                                    <td><input name="nilai_3_a" type="number" class="form-control text-center" placeholder="10 - 20" ></td>
                                    <td><textarea name="ket_3_a" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">1-9</td>
                                    <td><input name="nilai_3_b" type="number" class="form-control text-center" placeholder="1 - 9" ></td>
                                    <td><textarea name="ket_3_b" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td class="ps-4">C. Tidak Ada</td>
                                    <td class="text-center">0</td>
                                    <td><input name="nilai_3_c" type="number" class="form-control text-center" placeholder="0" ></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">1-20</td>
                                    <td><input name="nilai_4_a" type="number" class="form-control text-center" placeholder="1 - 20" ></td>
                                    <td><textarea name="ket_4_a" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">1-20</td>
                                    <td><input name="nilai_5_a" type="number" class="form-control text-center" placeholder="1 - 20" ></td>
                                    <td><textarea name="ket_5_a" class="form-control" placeholder="Keterangan" style="height: 42px"></textarea></td>
                                </tr>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#select-indikator').change(function(e) {
                    let indikator = $('#select-indikator').val();
                    console.log(indikator);
                    if (indikator === 'kelembagaan') {
                        $('#kelembagaan').show();
                        $('#manajemen').hide();
                    ...
                    } else if (indikator === 'usaha dan unit usaha') {
                        $('#kelembagaan').hide();
                        $('#manajemen').hide();
                    ...
                    } else if (indikator === 'kerjasama dan inovasi') {
                        $('#kelembagaan').hide();
                        $('#manajemen').hide();
                        $('#usaha-dan-unit-usaha').hide();
                    ...
                    } else if (indikator === 'aset dan permodalan') {
                        $('#kelembagaan').hide();
                        $('#manajemen').hide();
                        $('#usaha-dan-unit-usaha').hide();
                        $('#kerjasama-dan-inovasi').hide();
                    ...
                    } else if (indikator === 'adminstrasi laporan keuangan dan akuntabilitas') {
                        $('#kelembagaan').hide();
                        $('#manajemen').hide();
                        $('#usaha-dan-unit-usaha').hide();
                        $('#kerjasama-dan-inovasi').hide();
                    ...
                    } else if (indikator === 'keuntungan dan manfaat') {
                        $('#kelembagaan').hide();
                        $('#manajemen').hide();
                        $('#usaha-dan-unit-usaha').hide();
                        $('#kerjasama-dan-inovasi').hide();
