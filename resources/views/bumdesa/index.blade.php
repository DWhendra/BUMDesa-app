                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="text-center ">
                                                            <a class="btn btn-link text-success text-gradient px-3 mb-0"
                                                                href="{{ route('bumdesa.detail', $data2->id) }}"><i
                                                                    class="fas fa-clipboard-list me-2"></i>Detail</a>
                                                            <a class="btn btn-link text-dark px-3 mb-0"
                                                                href="{{ route('bumdesa.edit', $data2->id) }}"><i
                                                                    class="fas fa-pencil-alt text-dark me-2"
                                                                    aria-hidden="true"></i>Edit</a>
                                                            <form action="{{ route('bumdesa.destroy', $data2->id) }}"
                                                                method="post">
                                                                @method('delete')
                                                                @csrf
                                                                <button
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('bumdesa.search') }}" class="" method="GET">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-8 w-80">
                                <input type="text" maxlength="4" name="search" class="form-control"
                                    placeholder="Masukkan Tahun Laporan" required>
                            </div>
                            <div class="col-4 w-auto">
                                <div>
                                    <button type="submit" class="btn btn-primary btn-sm m-0">Cari</button>
                                    <a href="{{ route('bumdesa.index') }}">
                                        <button type="submit" class="btn btn-primary btn-sm m-0">Reset</button></a>
                                </div>
                            </div>
                        </div>
                    </form>
