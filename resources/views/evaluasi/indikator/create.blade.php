                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            <div class="form-floating mb-3">
                                                <input name="desa" type="text" class="form-control" id="floatingInput" placeholder="nama" required>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            <div class="form-floating mb-3">
                                                <input name="kecamatan" type="text" class="form-control" id="floatingInput" placeholder="nama">
