                        ...
                        <div class="card-header pb-0">
                            <div class="card-header pb-0">
                                <div class="d-flex align-items-center">
                                    <h6 class="mb-0">Edit Data SubKategori Aspek</h6>
                                    <a class="btn-sm ms-auto" href="{{ route('subkategori_aspek.index') }}"><button
                                            class="btn btn-primary btn-sm ms-auto">Kembali</button></a>
                                </div>
                            </div>
                        </div>

                        <form action="{{ route('subkategori_aspek.update', $subkategoriaspek->id) }}" method="POST"
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            <div class="form-floating mb-3">
                                                <input value="{{ $subkategoriaspek->nama }}" name="nama"
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            <div class="form-floating mb-3">
                                                <input value="{{ $subkategoriaspek->skor }}" name="skor"
                                                    type="text" class="form-control" id="floatingInput"
                                                    placeholder="nama" required>
