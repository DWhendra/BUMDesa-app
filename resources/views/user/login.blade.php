      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Di Aplikasi Badan Usaha Milik Desa Kabupaten Badung</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form" action="/login" method="post">
                @csrf
                <div class="mb-3">
                  <input name="username" type="text" class="form-control" placeholder="Username" aria-label="Name" required value="{{old('username')}}">
                </div>
                <div class="mb-3">
                ...
                <p class="text-sm mt-3 mb-0">Tidak memiliki Akun? <a href="{{route('home')}}" class="text-dark font-weight-bolder">Kembali</a></p>
              </form>
            </div>
          </div>
        </div>
