                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            ...
                            <a href="{{route('keuntungan-dan-manfaat.create')}}">
                                <div class="d-flex align-items-center">
                                    <button class="btn btn-success btn-md ms-auto"><i class="fas fa-plus me-3"></i>Tambah Data Keuntungan Dan Manfaat</button>
                                </div>
                            </a>
                        </div>
